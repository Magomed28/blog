...
class ProfileController extends Controller
{
	...
	public function actionView($nickname){
		...
		return $this->render('view',['user' => $this->findUser($nickname), 'currentUser' => $currentUser,
	...
	public function actionUploadPicture()
    {
        ...
        if ($model->validate()) {
            ...
            if ($user->save(false, ['picture'])) {
				 FeedService::updatePicture($user->getId(), $user->picture);
               return ['success' => true, 'pictureUri' => Yii::$app->storage->getFile($user->picture),];
            }
        }
